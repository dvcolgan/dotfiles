...
main() {
  ...
  tmux set-option -g status-left " #[fg=${dark_gray},reverse] "
  tmux set-option -g status-left-style "fg=${white},bg=${dark_purple},bold"
  tmux set-option -g status-right " #[bg=${black},reverse] %h %d, %Y "
  #tmux set-option -g status-right " #[bg=${black},reverse] %h %d, %Y %l:%M %p "
